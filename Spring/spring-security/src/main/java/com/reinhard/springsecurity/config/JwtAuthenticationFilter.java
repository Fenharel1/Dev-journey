...
// this is the first thing that will be executed on each request
@Component
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    // the context get Authentication means that the user is connected, if it's null the user isn't connected yet
